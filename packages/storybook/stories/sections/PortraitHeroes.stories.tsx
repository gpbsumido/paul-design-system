...
const meta = {
  ...
  parameters: { layout: 'fullscreen', docs: { description: { component: 'Portrait-hero compositions made with token CSS. SpiralPortraitHero uses a spiral; PerspectivePortraitHero uses a CSS perspective gallery. Decorative images never block the central copy or action slots. Empty and failed imagery leaves a complete section. No renderer dependencies.' } } },
  args: {
