...
import { Hero06, Hero13, Button, LiquidCarveButton } from '@paul-portfolio/react';
const images = [64, 65, 91, 177, 203, 219, 244, 250, 338, 342, 349, 399].map(id => ({ src: `https://picsum.photos/id/${id}/240/320` }));
const meta = {
  title: 'Sections/PortraitHeroes', component: Hero06, tags: ['autodocs'],
  parameters: { layout: 'fullscreen', docs: { description: { component: 'OriginKit-inspired compositions made with token CSS. Hero06 uses a spiral, Hero13 uses a CSS perspective gallery. Decorative images never block the central copy or action slots. Empty and failed imagery leaves a complete section. No renderer dependencies.' } } },
  args: {
...
export const Tunnel: Story = {
  ...
  render: args => <div data-theme="dark"><Hero13 {...args} /></div>,
};
